...
public class ActivityUtils {
     ...
     * 切换 Fragment
     */
    public static void switchFragment(@NonNull FragmentManager fragmentManager, Fragment targetFragment) {
        switchFragment(fragmentManager, targetFragment, R.id.frameLayout,  0, 0);
    }
